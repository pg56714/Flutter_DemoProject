class Performance {
  ...
  Performance({required this.q_id, required this.question});

  Map<String, dynamic> toMap() {
    return {'q_id': q_id, 'question': question};
  }

  Performance.fromMap(Map<String, dynamic> map) {
    q_id = map['q_id'];
    question = map['question'];
  }
}

class PerformanceScaleW {
  late int w_scale_id;
  ...
  PerformanceScaleW({required this.w_scale_id, required this.parent_id, required this.q1
  ...
  Map<String, dynamic> toMap() {
    return {'w_scale_id': w_scale_id, 'parent_id': parent_id, 'q1': q1
    , 'q2': q2, 'q3': q3, 'q4': q4
    , 'q5': q5, 'q6': q6, 'q7': q7
    , 'q8': q8, 'q9': q9, 'q10': q10
  ...
  PerformanceScaleW.fromMap(Map<String, dynamic> map) {
